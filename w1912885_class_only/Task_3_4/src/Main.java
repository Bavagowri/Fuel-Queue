        ...
        while (true) {                                                           //To run till user input EXT
            ...
            switch (selectedPrompt) {        //To perform the respective task when a button is selected
                ...
                case "VFQ":
                    ...
                    break;
                case "VEQ":               //To view all empty queues
                ...
                case "ACQ":
                    try{
                        queueNo = FuelQueue.miniLengthArray(queue1, queue2, queue3, queue4, queue5); //To add customer after checking the length of all array
                        switch (queueNo) {
                            case 1:                                                       //To add customer to the respective minimum length queue
                                System.out.println("queue1");
                    ...
                    break;
                case "RCQ":                 //to remove a random customer in queue by selecting their no in queue
                ...
                case "PCQ":              //To remove a served customer
                    try {                                                    //To validate the queue no
                        System.out.print("Select a Queue no (1,2,3,4,5): ");
                        queueNo = input.nextInt();
                        switch (queueNo) {
                            case 1:
                                System.out.println("queue1");
                                FuelQueue.removeCustomerServed(queue1,fuelStock,noliter1);
                                break;
                            case 2:
                                System.out.println("queue2");
                                FuelQueue.removeCustomerServed(queue2,fuelStock,noliter2);
                                break;
                            case 3:
                                System.out.println("queue3");
                                FuelQueue.removeCustomerServed(queue3,fuelStock,noliter3);
                                break;
                            case 4:
                                System.out.println("queue4");
                                FuelQueue.removeCustomerServed(queue4,fuelStock,noliter4);
                                break;
                            case 5:
                                System.out.println("queue5");
                                FuelQueue.removeCustomerServed(queue5,fuelStock,noliter5);
                                break;
                            default:
                                System.out.println("Queue number is invalid start again!");
                        }
                ...
                case "VCS":      //to output the selected queue after sorting alphabetically
                    try {                                                     //To validate the queue no
                        System.out.print("Select a Queue no (1,2,3,4,5): ");
                        queueNo = input.nextInt();
                ...
                case "SPD":            //to store in text file
                ...
                case "LPD":   //to load the program and write it into the console
                    try {                                  // To find if any error occurs
                ...
                case "IFQ":   // to view the income of queue selected
                    ...
                    break;
                default:
                    System.out.println("Menu option selected is invalid start again!");
                    break;
            }
        }
    }
